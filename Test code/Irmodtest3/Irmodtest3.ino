...
int pwm_summer(int MOD_PIN) {
  ...
  float lower_mod = 0.7;                            // Lower boundary of average value for modulated signal
  float lower_mix = 0.85;                           // Lower boundary of average value for mixmodulated signal (and upper for modulated)
  float lower_unm = 0.95;                           // Lower boundary of average value for unmodulated signal (and upper for mixmodulated)
